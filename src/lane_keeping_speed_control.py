...
def enc_callback(data):
    global v_x_enc, d_f, t0, dx_magnets
...
def cv_fail_callback(data):
    rospy.signal_shutdown('Failed to find lane too many times (controller shutting down)')
